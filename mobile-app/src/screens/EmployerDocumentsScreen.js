    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.header}>
                <Text style={styles.title}>{t('employer.nav.documents')}</Text> {/* Using generic documents title or specific employer one if fits better. 'Company Documents' was hardcoded. */}
...
const styles = StyleSheet.create({
    ...
    docType: { fontSize: 16, fontWeight: "bold", color: "#374151", flex: 1, marginRight: 10 },
...
export default EmployerDocumentsScreen;
